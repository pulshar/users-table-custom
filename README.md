...
Mostrar una tabla en la que los datos mostrados se recojan directamente del siguiente servicio web:
...
-Junto al buscador de la tabla, añadir un botón para crear un nuevo usuario. No se permite dejar vacío el campo del nombre ni el de usuario, ni crear un usuario con nombre de usuario repetido. La fecha de cumpleaños no es obligatoria, pero si se introduce, no puede ser superior a la fecha actual ni inferior a 1920
